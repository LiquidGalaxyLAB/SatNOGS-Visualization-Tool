...
import 'package:satnogs_visualization_tool/screens/satellite_info.dart';
    ...
    return ElevatedButton(
      onPressed: () {
        ...
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => SatelliteInfoPage(satellite: widget.satellite),
        ));
      },
      style: ButtonStyle(
                    ...
                    Padding(
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Text(
                                widget.satellite.getStatusLabel().toUpperCase(),
                                style: TextStyle(
